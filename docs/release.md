## Creating a release
The release process is handled via our [circle.yml](https://github.com/Kumar-River/chronograf/blob/master/circle.yml).
...
You can create a release tag from [Github](https://github.com/Kumar-River/chronograf/releases)
